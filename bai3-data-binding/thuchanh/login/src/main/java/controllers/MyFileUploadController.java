...
//
//    public String uploadOneFileHandlerPOST(HttpRequest request, Model model, @ModelAttribute("myUploadForm") MyUploadForm myUploadForm) {
//
...
//
//    public String uploadMultiFileHandlerPOST(HttpRequest request, Model model, @ModelAttribute("myUploadForm") MyUploadForm myUploadForm) {
//
//        return this.doUpload(request, model, myUploadForm);
//
//    }
